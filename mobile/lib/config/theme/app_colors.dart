...
class AppColors {
  ...
  static const Color primaryDark = Color(0xFF005C35);
  ...
  static const Color statusClientConfirmed = Color(0xFF059669);
  static const Color statusCancelled = Color(0xFFEF4444);
  static const Color statusDisputed = Color(0xFFDC2626);

  // Urgency colors
  static const Color urgencyLow = Color(0xFF22C55E);
  static const Color urgencyNormal = Color(0xFF3B82F6);
